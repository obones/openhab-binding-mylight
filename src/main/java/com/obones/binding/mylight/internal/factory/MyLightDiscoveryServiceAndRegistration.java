...
/**
 * The {@link MyLightDiscoveryServiceAndRegistration} stores both a discovery service and its associated registration.
 *
 * @author Olivier Sannier - Initial contribution
 */
@NonNullByDefault
public class MyLightDiscoveryServiceAndRegistration {
    private MyLightDiscoveryService discoveryService;
    private ServiceRegistration<?> discoveryServiceRegistration;

    public MyLightDiscoveryServiceAndRegistration(MyLightDiscoveryService discoveryService,
            ServiceRegistration<?> discoveryServiceRegistration) {
        this.discoveryService = discoveryService;
        this.discoveryServiceRegistration = discoveryServiceRegistration;
    }

    public MyLightDiscoveryService getDiscoveryService() {
